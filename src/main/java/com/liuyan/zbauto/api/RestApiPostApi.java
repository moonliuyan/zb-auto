...
@Slf4j
@Service
public class RestApiPostApi {
	private String symbol;
	@Autowired
	private UserApi userApi;
	public static final String url="https://trade.zb.center/api/";

	@Autowired
	private TradeRecordService tradeRecordService;

	public RestApiPostApi() {
...
//		params.put("apiIpBind", "");//不要传""
	...
	/** 现价买入 */
	public TradeResult buy(double price, double amount,String symbol) {
